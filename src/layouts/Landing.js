        ...
        <DemoNavbar />
         ...
         <main ref="main">
          <div className="position-relative"  style={{
            backgroundImage: "url(" + require("assets/img/image/bg12.jpg") + ")",
          ...
          <section className="section section-lg pt-lg-0" style={{marginTop: 100}}>
            <Container>
              <Row className="justify-content-center">
                <h1 style={{marginBottom: 50,  color: '#2469EF'}}>Layanan Unggulan yang Kami Berikan</h1>
                <Col lg="12">
                  <Row className="row-grid">
                    <Col lg="4">
                      <Card className="card-lift--hover shadow border-0">
                        <CardBody className="py-5">
                          <div className="rounded-circle text-center" style={{fontSize: 70, color: '#2469EF'}}>
                              <i className="fas fa-mobile-alt"></i>
                          </div>
                           <h4 className="text-primary text-center">Pengembangan Aplikasi</h4>
                      ...
                      <Card className="card-lift--hover shadow border-0">
                        <CardBody className="py-5">
                          <div className="rounded-circle text-center" style={{fontSize: 70, color: '#2469EF'}}>
                           ...
                           <h4 className="text-primary text-center">Desain UI / UX</h4>
                      ...
                      <Card className="card-lift--hover shadow border-0">
                        <CardBody className="py-5">
                          <div className="rounded-circle text-center" style={{fontSize: 70, color: '#2469EF'}}>
                           ...
                           <h4 className="text-primary text-center">Tugas Wireframing</h4>
            ...
            <Container>
              <Row className="row-grid align-items-center">
                 ...
                 <Col className="order-md-2" md="8">
                    <h3 style={{fontWeight: 'bold', fontSize: 40, color: '#2469EF'}}>
                    Gubuk-In
                  </h3>
                  <p>
          ...
          <section className="section section-lg" style={{marginTop: 100}}>
            <Container>
              <Row className="justify-content-center text-center mb-lg">
                <Col lg="8">
                  <h2 className="display-3" style={{color: '#2469EF'}}>Ini Tim Kami</h2>
              ...
              <Row>
                  ...
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title" style={{fontSize: 20}}>
                        <span className="d-block mb-1" style={{color: 'black'}}>Rega</span>
                        <h6 className="text-muted" style={{fontSize: 15}}>Frontend Developer</h6>
                      </h5>
                      <div className="mt-3">
                        <Button
                ...
                <Col className="mb-5 mb-lg-0" lg="4" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      ...
                      <h5 className="title" style={{fontSize: 20}}>
                        <span className="d-block mb-1" style={{color: 'black'}}>Redi</span>
                        <h6 className="text-muted" style={{fontSize: 15}}>Full Stack Developer</h6>
                      </h5>
                      <div className="mt-3">
                        <Button
                        className="btn-icon-only rounded-circle"
                ...
                <Col className="mb-5 mb-lg-0" lg="4" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title" style={{fontSize: 20}}>
                        <span className="d-block mb-1" style={{color: 'black'}}>Zulfian</span>
                        <h6 className="text-muted" style={{fontSize: 15}}>Frontend Developer</h6>
                      </h5>
                      <div className="mt-3">
                        <Button
                ...
                <Col className="mb-5 mb-lg-0" lg="4" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title" style={{fontSize: 20}}>
                        <span className="d-block mb-1" style={{color: 'black'}}>Vikra</span>
                        <h6 className="text-muted" style={{fontSize: 15}}>Backend Developer</h6>
                      </h5>
                      <div className="mt-3">
                        <Button
                        className="btn-icon-only rounded-circle"
                ...
                <Col className="mb-5 mb-lg-0" lg="4" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      ...
                      <h5 className="title" style={{fontSize: 20}}>
                        <span className="d-block mb-1" style={{color: 'black'}}>Dwiky</span>
                        <h6 className="text-muted" style={{fontSize: 15}}>Backend Developer</h6>
                      </h5>
                      <div className="mt-3">
                        <Button
                ...
                <Col className="mb-5 mb-lg-0" lg="4" md="6">
                  <div className="px-4">
                    ...
                    <div className="pt-4 text-center">
                      <h5 className="title" style={{fontSize: 20}}>
                        <span className="d-block mb-1" style={{color: 'black'}}>Ichlas</span>
                        <h6 className="text-muted" style={{fontSize: 15}}>Backend Developer</h6>
                      </h5>
                      <div className="mt-3">
                        <Button
